 ...
 */
?>
<!-- wp:group {"className":"ppw-testimonials","anchor":"testimonials","style":{"color":{"background":"#0a1628"},"spacing":{"padding":{"top":"var:preset|spacing|24","bottom":"var:preset|spacing|24"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group ppw-testimonials" id="testimonials" style="background-color:#0a1628">

  <!-- Section Header -->
  <!-- wp:group {"layout":{"type":"constrained","contentSize":"40rem"},"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|16"}}}} -->
  <div class="wp-block-group" style="margin-bottom:4rem">
    ...
    <!-- /wp:heading -->
    <!-- wp:paragraph {"style":{"typography":{"fontSize":"1rem","lineHeight":"1.6"},"color":{"text":"#a0b0c8"}}} -->
